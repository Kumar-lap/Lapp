...
var _users_get = _interopRequireDefault(require("../controllers/users_get"));
...
const userLocationSchema = {
  query: {
    ...
    search: _celebrate.Joi.string(),
    limit: _celebrate.Joi.number(),
    offset: _celebrate.Joi.number(),
    role: _celebrate.Joi.string(),
    userType: _celebrate.Joi.string(),
    all: _celebrate.Joi.bool()
  }
};
/**
 * @swagger
...
}), (0, _celebrate.celebrate)(userLocationSchema), _get_loggedIn_user.default, _users_get.default);
var _default = router;
