...
var _healfeed_get = _interopRequireDefault(require("../controllers/healfeed_get"));
 ...
 *     tags:
 *       - Healfeeds
 *     description: Returns list of heal feed
 *     consumes:
 *       - application/json
 *     produces:
 *       - application/json
...
}), _get_loggedIn_user.default, _healfeed_get.default);
var _default = router;
