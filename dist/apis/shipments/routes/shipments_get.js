...
var _shipments_get = _interopRequireDefault(require("../controllers/shipments_get"));
 ...
 *     tags:
 *       - Shipments
 *     description: Returns success message if Shipments details are added
 *     consumes:
 *       - application/json
 *     produces:
 *       - application/json
 ...
 *     tags:
 *       - Shipments
 *     description: Returns success message if Shipments details are updated
 *     consumes:
 *       - application/json
 *     produces:
 *       - application/json
...
}), _get_loggedIn_user.default, _shipments_get.default);
var _default = router;
